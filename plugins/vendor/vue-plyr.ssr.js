...
var isArrayIteratorMethod = function (it) {
  return (
    it !== undefined &&
    (iterators.Array === it || ArrayPrototype$1[ITERATOR] === it)
  )
}
...
_export(
  ...
  },
  {
    startsWith: function startsWith(
      ...
      notARegexp(searchString)
      var index = toLength(
        min$6(arguments.length > 1 ? arguments[1] : undefined, that.length)
      )
...
var nativeUrl = !fails(function () {
  ...
  return (
    ...
    !searchParams[ITERATOR$6] || // throws in Edge
    new URL('https://a@b').username !== 'a' ||
    new URLSearchParams(new URLSearchParams('a=b')).get('a') !== 'b' || // not punycoded in Edge
...
function _objectSpread2$1(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2
      ? ownKeys$2(Object(i), !0).forEach(function (t) {
          _defineProperty$1(e, t, i[t])
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(i))
      : ownKeys$2(Object(i)).forEach(function (t) {
...
function _createClass$1(e, t, i) {
  return (
    t && _defineProperties$1(e.prototype, t), i && _defineProperties$1(e, i), e
  )
}
...
function _objectSpread2$1$1(e) {
  for (var t = 1; t < arguments.length; t++) {
    var i = null != arguments[t] ? arguments[t] : {}
    t % 2
      ? ownKeys$1$1(Object(i), !0).forEach(function (t) {
          _defineProperty$1$1(e, t, i[t])
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(i))
      : ownKeys$1$1(Object(i)).forEach(function (t) {
          Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(i, t))
        })
  }
...
var getConstructor = function getConstructor(e) {
  ...
  isEmpty = function isEmpty(e) {
    return (
      isNullOrUndefined(e) ||
      ((isString(e) || isArray$1(e) || isNodeList(e)) && !e.length) ||
...
var RangeTouch = (function () {
    function e(t, i) {
      _classCallCheck$1(this, e),
        ...
        is.element(this.element) &&
          ...
          ((this.config = _objectSpread2$1$1({}, defaults, {}, i)), this.init())
    }
            ...
            value: function value(t) {
              ...
              if (
                (is.empty(t) || is.string(t)
                  ...
                  : is.nodeList(t)
                  ? (n = Array.from(t))
                  : is.array(t) && (n = t.filter(is.element)),
                is.empty(n))
              )
                return null
  ...
  isCue = function isCue(e) {
    return (
      instanceOf$1(e, window.TextTrackCue) || instanceOf$1(e, window.VTTCue)
    )
  },
  isTrack = function isTrack(e) {
    return (
      instanceOf$1(e, TextTrack) ||
      (!isNullOrUndefined$1(e) && isString$1(e.kind))
    )
  },
  ...
  isEmpty$1 = function isEmpty$1(e) {
    return (
      ...
      ((isString$1(e) || isArray$1$1(e) || isNodeList$1(e)) && !e.length) ||
      (isObject$1$1(e) && !Object.keys(e).length)
    )
  },
...
function extend() {
  ...
  var s = i.shift()
  return is$1.object(s)
    ? (Object.keys(s).forEach(function (t) {
        is$1.object(s[t])
          ? (Object.keys(e).includes(t) ||
              Object.assign(e, _defineProperty$1({}, t, {})),
            extend(e[t], s[t]))
          : Object.assign(e, _defineProperty$1({}, t, s[t]))
      }),
      extend.apply(void 0, [e].concat(i)))
    : e
}
...
function createElement(e, t, i) {
  ...
  return (
    is$1.object(t) && setAttributes(n, t),
    is$1.string(i) && (n.innerText = i),
    n
  )
}
...
function removeElement(e) {
  is$1.nodeList(e) || is$1.array(e)
    ? Array.from(e).forEach(removeElement)
    : is$1.element(e) &&
      is$1.element(e.parentNode) &&
...
function replaceElement(e, t) {
  return is$1.element(t) && is$1.element(t.parentNode) && is$1.element(e)
  ...
  support = {
    ...
    check: function check(e, t, i) {
      ...
      return {
        api: s,
        ui:
          s && support.rangeInput && ('video' !== e || !browser.isIPhone || n),
      }
    },
    pip: !(
      browser.isIPhone ||
      (!is$1.function(createElement('video').webkitSetPresentationMode) &&
...
function ready() {
  ...
  return new Promise(function (t) {
    return e.ready
      ? setTimeout(t, 0)
      : on.call(e, e.elements.container, 'ready', t)
  }).then(function () {})
}
...
function validateRatio(e) {
  return (
    !!(is$1.array(e) || (is$1.string(e) && e.includes(':'))) &&
    (is$1.array(e) ? e : e.split(':')).map(Number).every(is$1.number)
  )
}
...
function setAspectRatio(e) {
  ...
  if (
    ...
    this.isHTML5 &&
      t.classList.toggle(this.config.classNames.videoFixedRatio, null !== i)
  ...
  setup: function setup() {
    if (this.isHTML5) {
      ...
      ;(e.options.speed = e.config.speed.options),
        is$1.empty(this.config.ratio) || setAspectRatio.call(e),
          ...
          set: function set(t) {
            if (e.quality !== t) {
              if (
                ...
                is$1.function(e.config.quality.onChange)
              )
...
function loadSprite(e, t) {
  if (is$1.string(e)) {
    var i = 'cache',
      ...
      a = function a(e, t) {
        ;(e.innerHTML = t),
          (n && s()) || document.body.insertAdjacentElement('afterbegin', e)
      }
...
var controls = {
  ...
  findElements: function findElements() {
    try {
      return (
        ...
        is$1.element(this.elements.progress) &&
  ...
  createButton: function createButton(e, t) {
    ...
    return (
      a.toggle
        ? (r.appendChild(
            controls.createIcon.call(this, a.iconPressed, {
              class: 'icon--pressed',
            })
          ),
          r.appendChild(
            controls.createIcon.call(this, a.icon, {
              class: 'icon--not-pressed',
            })
          ),
          r.appendChild(
            controls.createLabel.call(this, a.labelPressed, {
              class: 'label--pressed',
            })
          ),
          r.appendChild(
            controls.createLabel.call(this, a.label, {
              class: 'label--not-pressed',
            })
          ))
        : (r.appendChild(controls.createIcon.call(this, a.icon)),
          r.appendChild(controls.createLabel.call(this, a.label))),
      extend(n, getAttributesFromSelector(this.config.selectors.buttons[s], n)),
      setAttributes(r, n),
      'play' === s
        ? (is$1.array(this.elements.buttons[s]) ||
      ...
      function (n) {
        if (
          ...
          if (!a && [32, 39].includes(n.which))
            controls.showMenuPanel.call(i, t, !0)
          else
            32 !== n.which &&
              (40 === n.which || (a && 39 === n.which)
                ? ((s = e.nextElementSibling),
                  is$1.element(s) || (s = e.parentNode.firstElementChild))
                : ((s = e.previousElementSibling),
                  is$1.element(s) || (s = e.parentNode.lastElementChild)),
              setFocus.call(i, s, !0))
        }
      },
      !1
  ...
  createMenuItem: function createMenuItem(e) {
    ...
    ;(h.innerHTML = a),
      is$1.element(o) && h.appendChild(o),
      d.appendChild(h),
      ...
      this.listeners.bind(
        ...
        function (e) {
          if (!is$1.keyboardEvent(e) || 32 === e.which) {
            switch (
              (e.preventDefault(), e.stopPropagation(), (d.checked = !0), s)
            ) {
              case 'language':
      ...
      controls.bindMenuItemShortcuts.call(this, d, s),
      n.appendChild(d)
  },
  ...
  updateVolume: function updateVolume() {
    this.supported.ui &&
      (is$1.element(this.elements.inputs.volume) &&
        controls.setRange.call(
          this,
          this.elements.inputs.volume,
          this.muted ? 0 : this.volume
        ),
      is$1.element(this.elements.buttons.mute) &&
    ...
    if (this.supported.ui && is$1.event(e)) {
      ...
      if (e)
        switch (e.type) {
          ...
          case 'seeking':
          case 'seeked':
            ;(i = getPercentage(this.currentTime, this.duration)),
              'timeupdate' === e.type &&
                controls.setRange.call(this, this.elements.inputs.seek, i)
            break
  ...
  updateRangeFill: function updateRangeFill(e) {
    ...
    if (is$1.element(t) && 'range' === t.getAttribute('type')) {
      ...
      browser.isWebkit &&
        t.style.setProperty('--value', ''.concat((t.value / t.max) * 100, '%'))
    }
  },
  updateSeekTooltip: function updateSeekTooltip(e) {
    ...
    if (
      ...
      if (this.touch) n(!1)
        ...
        if (is$1.event(e)) s = (100 / a.width) * (e.pageX - a.left)
        else {
        ...
        s < 0 ? (s = 0) : s > 100 && (s = 100),
          ...
          (this.elements.display.seekTooltip.style.left = ''.concat(s, '%')),
          is$1.event(e) &&
  ...
  timeUpdate: function timeUpdate(e) {
    var t =
      !is$1.element(this.elements.display.duration) && this.config.invertTime
    controls.updateTimeDisplay.call(
      this,
  ...
  updateSetting: function updateSetting(e, t, i) {
    ...
    if ('captions' === e) s = this.currentTrack
      ...
      if (
        ((s = is$1.empty(i) ? this[e] : i),
        is$1.empty(s) && (s = this.config[e].default),
        !is$1.empty(this.options[e]) && !this.options[e].includes(s))
      )
    ...
    if (
      (is$1.element(a) || (a = n && n.querySelector('[role="menu"]')),
      is$1.element(a))
    ) {
      this.elements.settings.buttons[e].querySelector(
        '.'.concat(this.config.classNames.menu.value)
      ).innerHTML = controls.getLabel.call(this, e, s)
  ...
  setQualityMenu: function setQualityMenu(e) {
    ...
    if (is$1.element(this.elements.settings.panels.quality)) {
      ...
      if (
        (controls.toggleMenuButton.call(this, i, s),
        emptyElement(n),
  ...
  setCaptionsMenu: function setCaptionsMenu() {
    ...
    if (is$1.element(this.elements.settings.panels.captions)) {
      var t = 'captions',
        i = this.elements.settings.panels.captions.querySelector(
          '[role="menu"]'
        ),
      ...
      if (
        ...
        var a = n.map(function (t, n) {
          return {
            ...
            badge:
              t.language &&
              controls.createBadge.call(e, t.language.toUpperCase()),
            list: i,
            type: 'language',
          }
        })
        a.unshift({
          ...
          a.forEach(controls.createMenuItem.bind(this)),
  ...
  setSpeedMenu: function setSpeedMenu() {
    ...
    if (is$1.element(this.elements.settings.panels.speed)) {
      ...
      controls.toggleMenuButton.call(this, t, n),
        emptyElement(i),
        controls.checkMenu.call(this),
        n &&
  ...
  toggleMenu: function toggleMenu(e) {
    ...
    if (is$1.element(t) && is$1.element(i)) {
      var n = t.hidden,
        s = n
      if (is$1.boolean(e)) s = e
      else if (is$1.keyboardEvent(e) && 27 === e.which) s = !1
      ...
      i.setAttribute('aria-expanded', s),
        ...
        s && is$1.keyboardEvent(e)
          ? controls.focusFirstMenuItem.call(this, null, !0)
          : s || n || setFocus.call(this, i, is$1.keyboardEvent(e))
    }
  },
  ...
  showMenuPanel: function showMenuPanel() {
    ...
    if (is$1.element(n)) {
        ...
        var r = controls.getMenuSize.call(this, n),
          o = function t(i) {
            i.target === s &&
              ...
              ((s.style.width = ''),
              (s.style.height = ''),
              off.call(e, s, transitionEndEvent, t))
          }

        on.call(this, s, transitionEndEvent, o),
      ...
      toggleHidden(a, !0),
        toggleHidden(n, !1),
        controls.focusFirstMenuItem.call(this, n, i)
    }
  },
  ...
  create: function create(e) {
    ...
    return (
      dedupe(
        ...
        if (
          ...
          var l = createElement('div', {
            ...
            h = createElement(
              'div',
              getAttributesFromSelector(t.config.selectors.progress)
            )
        ...
        if (
          ...
          'settings' === o && !is$1.empty(t.config.settings))
        ) {
          var f = createElement(
            'div',
            extend({}, d, {
          ...
          b.appendChild(w),
              ...
              var s = createElement(
                ...
                extend(
                  getAttributesFromSelector(
                    t.config.selectors.buttons.settings
                  ),
                  {
                    type: 'button',
                    class: ''
            ...
            (t.elements.settings.menu = f)
        }

        if (
          ('pip' === o && support.pip && u.appendChild(n.call(t, 'pip', d)),
          'airplay' === o &&
            support.airplay &&
      ...
      this.isHTML5 && o.call(this, html5.getQualityOptions.call(this)),
      l.call(this),
      u
    )
  },
  inject: function inject() {
    ...
    var n = {
      ...
      s = !0
    is$1.function(this.config.controls) &&
      (this.config.controls = this.config.controls.call(this, n)),
      this.config.controls || (this.config.controls = []),
      is$1.element(this.config.controls) || is$1.string(this.config.controls)
        ? (i = this.config.controls)
        : ((i = controls.create.call(this, {
            id: this.id,
            seektime: this.config.seekTime,
            speed: this.speed,
    ...
    if (
      (s &&
        ...
        (i = a)),
      is$1.string(this.config.selectors.controls.container) &&
        (r = document.querySelector(this.config.selectors.controls.container)),
      is$1.element(r) || (r = this.elements.container),
      r[is$1.element(i) ? 'insertAdjacentElement' : 'insertAdjacentHTML'](
        'afterbegin',
        i
      ),
      is$1.element(this.elements.controls) || controls.findElements.call(this),
      !is$1.empty(this.elements.buttons))
    ) {
      var o = function o(t) {
    ...
    if ((browser.isEdge && repaint(r), this.config.tooltips.controls)) {
      ...
      Array.from(h).forEach(function (t) {
        toggleClass(t, e.config.classNames.hidden, !1),
          toggleClass(t, e.config.classNames.tooltip, !0)
      })
    }
  },
}
    ...
    setup: function setup() {
      if (this.supported.ui)
        if (
          ...
          if (
            (is$1.element(this.elements.captions) ||
          ...
          if (
            (is$1.boolean(n) || (n = this.config.captions.active),
        ...
        t
          ...
          .forEach(function (t) {
            e.debug.log('Track added', t),
              ...
              on.call(e, t, 'cuechange', function () {
                return captions.updateCues.call(e)
              })
          }),
        ((o && this.language !== s) || !t.includes(r)) &&
          (captions.setLanguage.call(this, s),
          captions.toggle.call(this, n && o)),
        toggleClass(
          this.elements.container,
        ...
        if (a !== n) {
          if (
            ...
            return (
              ...
              void captions.set.call(this, r.indexOf(o))
            )
          }

          this.elements.buttons.captions &&
            (this.elements.buttons.captions.pressed = a),
            toggleClass(this.elements.container, s, a),
  ...
  defaults$1 = {
    ...
    urls: {
      ...
      youtube: {
        ...
        api: 'https://www.youtube.com/embed/{0}',
      },
      googleIMA: {
    ...
    function e(t) {
      ...
      _classCallCheck(this, e),
        ...
        on.call(
          ...
          'dblclick',
          function (e) {
            ;(is$1.element(i.player.elements.controls) &&
                ...
                ['webkit', 'moz', 'ms'].some(function (t) {
                  return (
                    !(
                      ...
                      !is$1.function(document[''.concat(t, 'CancelFullScreen')])
                    ) && ((e = t), !0)
                  )
                }),
                e
...
var ui = {
    ...
    build: function build() {
      ...
      is$1.element(this.elements.controls) ||
        ...
        this.poster &&
          ui.setPoster.call(this, this.poster, !1).catch(function () {}),
    ...
    setTitle: function setTitle() {
      ...
      if (
        (is$1.string(this.config.title) &&
          !is$1.empty(this.config.title) &&
      ...
      toggleClass(
        ...
        Array.from(this.elements.buttons.play || []).forEach(function (e) {
          Object.assign(e, {
            ...
            e.setAttribute(
              'aria-label',
              i18n.get(t.playing ? 'pause' : 'play', t.config)
            )
        }),
        (is$1.event(e) && 'timeupdate' === e.type) ||
    ...
    migrateStyles: function migrateStyles() {
      var e = this
      Object.values(_objectSpread2$1({}, this.media.style))
        .filter(function (e) {
      ...
      _createClass(e, [
            ...
            if (
              ...
              if (s) {
                ...
                if (is$1.element(r)) {
                  ...
                  if (
                    32 === e.which &&
                    matches$1(r, 'button, [role^="menuitem"]')
                  )
                    return
                }
            ...
            if (
              ...
              if ('focus' !== e.type || s)
                (n = t.config.classNames.tabFocus),
                  toggleClass(getElements.call(t, '.'.concat(n)), n, !1),
                  'focusout' !== e.type &&
          ...
          value: function value() {
              ...
              on.call(
                ...
                function (t) {
                  ...
                  ;['touchstart', 'touchmove', 'mousemove'].includes(t.type) &&
                    (ui.toggleControls.call(e, !0), (a = e.touch ? 3e3 : 2e3)),
            ...
            on.call(
              ...
              function (t) {
                ...
                if (
                  r === i.container &&
                  (e.isEmbed || !is$1.empty(e.config.ratio))
                ) {
                  ...
                  !(function (t, i, n) {
                    ...
                    o ||
                      (l
                        ? on.call(e, window, 'resize', a)
                        : off.call(e, window, 'resize', a))
                }
              }
            )
          },
        },
        {
          ...
          value: function value() {
            ...
            if (
              (on.call(t, t.media, 'timeupdate seeking seeked', function (e) {
            ...
            t.supported.ui &&
              ...
              on.call(t, t.media, 'volumechange', function () {
                t.storage.set({
                  volume: t.volume,
                  muted: t.muted,
                })
              ...
              on.call(t, t.media, 'ratechange', function () {
                controls.updateSetting.call(t, 'speed'),
                  t.storage.set({
                    speed: t.speed,
                  })
              }),
            ...
            on.call(t, t.media, s, function (e) {
              ...
              'error' === e.type && (s = t.media.error),
                triggerEvent.call(t, i.container, e.type, !0, s)
            })
          },
        },
        {
          ...
          value: function value(e, t, i) {
            var n = this.player,
              ...
              a = !0
            is$1.function(s) && (a = s.call(n, e)),
              !1 !== a && is$1.function(t) && t.call(n, e)
          },
        },
        {
          key: 'bind',
        ...
        },
        {
          ...
          value: function value() {
                  ...
                  ;[13, 32].includes(i) &&
                    (13 !== i
                      ? (e.preventDefault(),
                        e.stopPropagation(),
                        controls.toggleMenu.call(t, e))
                      : controls.focusFirstMenuItem.call(t, null, !0))
                },
                null,
                !1
              ),
              ...
              this.bind(
                ...
                function (e) {
                  ...
                  if (!is$1.keyboardEvent(e) || 39 === n || 37 === n) {
                    ...
                    a && r
                      ? (i.removeAttribute(s), silencePromise(t.play()))
                      : !r && t.playing && (i.setAttribute(s, ''), t.pause())
                  }
                }
              ),
              browser.isIos)
            ...
            this.bind(
              ...
              browser.isWebkit &&
                Array.from(getElements.call(t, 'input[type="range"]')).forEach(
                  function (i) {
...
var vimeo = {
  ...
  ready: function ready() {
    ...
    c.setAttribute('src', u),
      ...
      c.setAttribute('allow', 'autoplay,fullscreen,picture-in-picture'),
      is$1.empty(s) || c.setAttribute('referrerPolicy', s)
    var d = t.poster
    if (n)
      c.setAttribute('data-poster', d), (t.media = replaceElement(c, t.media))
    else {
    ...
    fetch(format(t.config.urls.vimeo.api, l), 'json').then(function (e) {
      if (!is$1.empty(e)) {
        ...
        ;(i.pathname = ''.concat(i.pathname.split('_')[0], '.jpg')),
          ui.setPoster.call(t, i.href).catch(function () {})
      }
    }),
    ...
    Object.defineProperty(t.media, 'loop', {
      ...
      t.embed.on('loaded', function () {
        ;(t.embed.getPaused().then(function (e) {
          assurePlaybackState.call(t, !e),
            e || triggerEvent.call(t, t.media, 'playing')
        }),
        is$1.element(t.embed.element) && t.supported.ui) &&
      ...
      t.embed.on('timeupdate', function (e) {
        ;(t.media.seeking = !1),
          (m = e.seconds),
          triggerEvent.call(t, t.media, 'timeupdate')
      }),
      t.embed.on('progress', function (e) {
        ;(t.media.buffered = e.percent),
          triggerEvent.call(t, t.media, 'progress'),
          1 === parseInt(e.percent, 10) &&
            triggerEvent.call(t, t.media, 'canplaythrough'),
          t.embed.getDuration().then(function (e) {
            e !== t.media.duration &&
              ((t.media.duration = e),
              triggerEvent.call(t, t.media, 'durationchange'))
          })
      }),
...
function parseId$1(e) {
  if (is$1.empty(e)) return null
  return e.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/)
    ? RegExp.$2
    : e
}
...
var youtube = {
    setup: function setup() {
      ...
      if (
        ...
        is$1.object(window.YT) && is$1.function(window.YT.Player))
      )
      ...
      _createClass(e, [
        {
          ...
          value: function value() {
            var e = this
            this.enabled &&
              (is$1.object(window.google) && is$1.object(window.google.ima)
                ? this.ready()
          ...
          value: function value() {
            ...
            var i = function i() {
              var t = _formatTime(Math.max(e.manager.getRemainingTime(), 0)),
                i = ''
                  .concat(i18n.get('advertisement', e.player.config), ' - ')
                  .concat(t)
          ...
          value: function value() {
            ...
            this.player.on('canplay', function () {
              ...
              this.player.on('seeked', function () {
                ...
                is$1.empty(t.cuePoints) ||
                  t.cuePoints.forEach(function (n, s) {
                    e < n &&
                      n < i &&
                      (t.manager.discardAdBreak(), t.cuePoints.splice(s, 1))
                  })
              }),
        ...
        },
        {
          ...
          value: function value(e, t) {
            return (
              is$1.array(this.events[e]) || (this.events[e] = []),
        ...
        },
        {
          ...
          value: function value(e) {
            is$1.nullOrUndefined(this.safetyTimer) ||
        ...
        },
        {
          ...
          get: function get() {
            ...
            return (
              ...
              this.player.isVideo &&
              e.enabled &&
              (!is$1.empty(e.publisherId) || is$1.url(e.tagUrl))
            )
          },
        },
        {
          ...
          value: function value(e) {
            ...
            return new Promise(function (i) {
              fetch(e).then(function (n) {
                ...
                var a = new Image()
                ;(a.onload = function () {
                  ;(s.height = a.naturalHeight),
                    (s.width = a.naturalWidth),
                    t.thumbnails.push(s),
                    i()
                }),
            ...
            if (
              ...
              if ('touchmove' === e.type)
                ...
                ;(this.seekTime = this.player.media.duration * (i / 100)),
                  ...
                  (this.elements.thumb.time.innerText = _formatTime(
                    this.seekTime
                  ))
              }
        ...
        },
        {
          ...
          value: function value() {
            ...
            ;(this.elements.thumb.time = createElement('span', {}, '00:00')),
              ...
              is$1.element(this.player.elements.progress) &&
        ...
        },
        {
          ...
          value: function value() {
            ...
            if (
              ...
              this.showImage(this.currentImageElement, a, t, i, r, !1),
      ...
      getDeep(e, 'sources.length')
        ? (html5.cancelRequests.call(this),
          this.destroy.call(
            ...
            function () {
              ;(t.options.quality = []),
                removeElement(t.media),
                (t.media = null),
                is$1.element(t.elements.container) &&
              ...
              Object.assign(t, {
                ...
                ui.addStyleHook.call(t),
                t.isHTML5 && source.insertElements.call(t, 'source', i),
                (t.config.title = e.title),
                media.setup.call(t),
                t.isHTML5 &&
                  Object.keys(e).includes('tracks') &&
                  source.insertElements.call(t, 'track', e.tracks),
                (t.isHTML5 || (t.isEmbed && !t.supported.ui)) &&
                  ui.build.call(t),
                t.isHTML5 && t.media.load(),
                is$1.empty(e.previewThumbnails) ||
                  (Object.assign(
                  ...
                  t.config.previewThumbnails.enabled &&
                    (t.previewThumbnails = new PreviewThumbnails(t))),
                t.fullscreen.update()
            },
            !0
          ))
          ...
          switch (a) {
            case 'div':
              if (((r = this.media.querySelector('iframe')), is$1.element(r))) {
                if (
                  ((o = parseUrl(r.getAttribute('src'))),
                  (this.provider = getProviderByUrl(o.toString())),
          ...
          ;(this.supported = support.check(
            ...
            this.supported.api
              ? ((this.eventListeners = []),
                ...
                is$1.element(this.elements.container) ||
                  ((this.elements.container = createElement('div', {
                    tabindex: 0,
                  })),
      ...
      [
        {
          ...
          value: function value() {
            var e = this
            return is$1.function(this.media.play)
              ? (this.ads &&
                  this.ads.enabled &&
        ...
        },
        {
          key: 'pause',
          value: function value() {
            return this.playing && is$1.function(this.media.pause)
              ? this.media.pause()
              : null
          },
        },
        {
          key: 'togglePlay',
          value: function value(e) {
            return (is$1.boolean(e) ? e : !this.playing)
              ? this.play()
              : this.pause()
          },
        },
        {
          ...
          value: function value() {
            this.isHTML5
              ...
              : is$1.function(this.media.stop) && this.media.stop()
          },
        },
        {
          key: 'restart',
          ...
          value: function value(e) {
            ...
            if (this.ready) {
                ...
                ;(document.body.style.overflow = ''),
                  ...
                  i
                    ? (Object.keys(t.elements).length &&
                        (removeElement(t.elements.buttons.play),
                        removeElement(t.elements.captions),
                        removeElement(t.elements.controls),
                        removeElement(t.elements.wrapper),
                        (t.elements.buttons.play = null),
                        (t.elements.captions = null),
                        (t.elements.controls = null),
                        (t.elements.wrapper = null)),
                      is$1.function(e) && e())
                    : (unbindListeners.call(t),
                      html5.cancelRequests.call(t),
                      replaceElement(t.elements.original, t.elements.container),
                      triggerEvent.call(
                        t,
                        t.elements.original,
                        'destroyed',
                      ...
                      is$1.function(e) && e.call(t.elements.original),
                      (t.ready = !1),
                      setTimeout(function () {
              ...
              this.stop(),
                ...
                this.isHTML5
                  ? (ui.toggleNativeControls.call(this, !0), n())
                  : this.isYouTube
        ...
        },
        {
          ...
          set: function set(e) {
            var t = e
            is$1.string(t) && (t = Number(t)),
              is$1.number(t) || (t = this.storage.get('volume')),
              is$1.number(t) || (t = this.config.volume),
              t > 1 && (t = 1),
              t < 0 && (t = 0),
              (this.config.volume = t),
              (this.media.volume = t),
              !is$1.empty(e) && this.muted && t > 0 && (this.muted = !1)
          },
          get: function get() {
        ...
        },
        {
          ...
          set: function set(e) {
            var t = e
            is$1.boolean(t) || (t = this.storage.get('muted')),
              is$1.boolean(t) || (t = this.config.muted),
              (this.config.muted = t),
              (this.media.muted = t)
          },
          get: function get() {
        ...
        },
        {
          ...
          set: function set(e) {
            var t = this,
              i = null
            is$1.number(e) && (i = e),
              is$1.number(i) || (i = this.storage.get('speed')),
              is$1.number(i) || (i = this.config.speed.selected)
        ...
        },
        {
          ...
          get: function get() {
            return this.isYouTube
              ? Math.min.apply(Math, _toConsumableArray(this.options.speed))
              : this.isVimeo
              ? 0.5
              : 0.0625
          },
        },
        {
          ...
          get: function get() {
            return this.isYouTube
              ? Math.max.apply(Math, _toConsumableArray(this.options.speed))
              : this.isVimeo
              ? 2
              : 16
          },
        ...
        },
        {
          ...
          set: function set(e) {
            this.isVideo
              ? is$1.string(e) && validateRatio(e)
                ? ((this.config.ratio = e), setAspectRatio.call(this))
                : this.debug.error(
        ...
        },
        {
          ...
          set: function set(e) {
            if (support.pip) {
              ...
              is$1.function(this.media.webkitSetPresentationMode) &&
                this.media.webkitSetPresentationMode(
                  t ? pip.active : pip.inactive
                ),
                is$1.function(this.media.requestPictureInPicture) &&
                  (!this.pip && t
          ...
          get: function get() {
            return support.pip
              ? is$1.empty(this.media.webkitPresentationMode)
          ...
          value: function value(t) {
            ...
            return (
              is$1.string(t)
                ...
                : is$1.nodeList(t)
                ? (n = Array.from(t))
                : is$1.array(t) && (n = t.filter(is$1.element)),
              is$1.empty(n)
                ? null
                : n.map(function (t) {
                    return new e(t, i)
