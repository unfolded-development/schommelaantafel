  ...
  mounted() {
    ...
    setTimeout(() => {
      ...
      for (let index = 0; index < introAnimationBlokItems.length; index++) {
        introAnimationBlokItems[index].classList.add("intro__animation-block-item--load");
      }
      ...
      setTimeout(() => {
        ...
        // Show cookiebar, website content and let the user scroll on webpage after the animation is finished
