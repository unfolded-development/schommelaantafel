    ...
    <div class="slider-selector__main">
        ...
        <div class="slider__slide slider-selector__wrapper">
            ...
            <div class="slider-selector__content">
                ...
                <Slider ref="contentSlider" class="slider-selector__content-slider" :options="{ prevNextButtons: true, pageDots: false, sync:'.slider-selector__image-slider .slider'  }">
                    <div class="slider-selector__content" v-for="contentVarient in setSubject" :key="contentVarient.name">
