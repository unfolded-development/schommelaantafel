<template>
    <div class="slider-selector__main">
        <Slider ref="mainslider" class="slider-selector__image-slider" :options="{ prevNextButtons: false, pageDots: false, wrapAround: true }" style="grid-column: span 8;">
        ...
        <div class="slider__slide slider-selector__wrapper">
            ...
            <div class="slider-selector__content">
                ...
                <Slider ref="contentSlider" class="slider-selector__content-slider" :options="{ prevNextButtons: true, pageDots: false, sync:'.slider-selector__image-slider .slider', wrapAround: true }">
