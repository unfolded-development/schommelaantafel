<template>
  <Slider :option='{wrapAround: true, prevNextButtons: false, pageDots: true}' ref='slider'
          :class='{"slider--dragging": dragging}'>
    <div class='slider__slide'>
      <vue-plyr ref='plyr1' :options='playerOptions'>
        <div data-plyr-provider='youtube' data-plyr-embed-id='tT7n-K0suAA'></div>
      </vue-plyr>
    </div>
    <div class='slider__slide' @click='clickGate'>
      <vue-plyr ref='plyr2' :options='playerOptions'>
        <div data-plyr-provider='youtube' data-plyr-embed-id='I1j8X9la6SI'></div>
      </vue-plyr>
    </div>
    <div class='slider__slide' @click='clickGate'>
      <vue-plyr ref='plyr3' :options='playerOptions'>
        <div data-plyr-provider='youtube' data-plyr-embed-id='I-4XSXjjxBc'></div>
      </vue-plyr>
    </div>
  </Slider>
</template>
