<template>
    <section class="intro-loader">
        <svg class="intro-loader__logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="145" height="50.001" viewBox="0 0 145 50.001">
            <defs>
            ...
            <g id="Group_34" data-name="Group 34" transform="translate(0 0)">
                ...
                <path class="animate-letter" :transform="letterOTransform" id="Fill_8" data-name="Fill 8" d="M9.5,19a9.4,9.4,0,0,1-6.927-2.7A9.58,9.58,0,0,1,0,9.527,9.627,9.627,0,0,1,2.632,2.739,9.352,9.352,0,0,1,9.421,0C15.061,0,19,3.9,19,9.473a9.63,9.63,0,0,1-2.6,6.778A9.345,9.345,0,0,1,9.5,19ZM9.474,3.414c-3.362,0-5.621,2.446-5.621,6.086,0,3.568,2.322,6.061,5.648,6.061,3.378,0,5.648-2.436,5.648-6.061C15.148,5.916,12.815,3.414,9.474,3.414Z" fill="#ff6047"/>
