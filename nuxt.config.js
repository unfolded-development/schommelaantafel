export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'msapplication-TileColor', content: '#ffa803' },
    ...
    script: [
      {
        src:
          process.env.JWPLAYER_PLAYER_LIBRARY_URL ||
  ...
  plugins: [
    { src: '~/plugins/CleanHtmlDirective.js', ssr: true },
    { src: '~/plugins/ServiceContainer.js', ssr: true },
    { src: '~/plugins/VueFlickity.js', ssr: false },
    { src: '~/plugins/VuePlyr.js', ssr: false },
    { src: '~/plugins/VueLottiePlayer.js', ssr: false },
    { src: '~/plugins/VueCookie.js', ssr: true },
  ],
  ...
  pwa: {
    meta: {
      ...
      description:
        'De Koning komt KennisMaken met Eindhoven. Doe dat ook! Eindhoven, stad van Kennis, stad van het Maken.',
      theme_color: '#FF6E00',
      lang: 'nl',
